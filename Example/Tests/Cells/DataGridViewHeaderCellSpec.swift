//
//  DataGridViewHeaderCellSpec.swift
//
...
class DataGridViewHeaderCellSpec: QuickSpec {
    override func spec() {
        var cell: DataGridViewHeaderCell!

        beforeEach {
            cell = DataGridViewHeaderCell(frame: CGRect(x: 0, y: 0, width: 100, height: 60))
        }
